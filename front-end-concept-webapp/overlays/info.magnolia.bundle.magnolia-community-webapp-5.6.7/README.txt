...
This package contains:
   ...
   Magnolia Core 5.6.6
   magnolia-empty-webapp 5.6.7
   magnolia-empty-webapp 5.6.7
   Magnolia Internationalization Framework 5.6.6
   Magnolia JAAS 5.6.6
   Google Sitemap Module 2.5
   magnolia-module-mail 5.5
   magnolia-module-rssaggregator 2.6
   Magnolia Rendering 5.6.6
   Magnolia Templating 5.6.6
   Magnolia Templating for JSP 5.6.6
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.6.7.html
